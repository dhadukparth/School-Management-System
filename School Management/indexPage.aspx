...
<body>
    <form id="form1" runat="server">
        ...
        <footer>
            <p>Copyright &copy; 2022 patel school design by || Parth Patel || <a href="#">terms or condition</a></p>
        </footer>
        ...
        <%--<div class="forms">
            <form>
                <div class="form__header">
                    <h2>Sign In</h2>
                    <i class='bx bx-x' id="signinClose"></i>
                </div>
                <div class="form__body">
                    <div class="input__box">
                        <label for="Role">Role</label>
                        <select id="role" required="required"="required="required"">
                    ...
                    <div class="input__box">
                        ...
                        <input type="text" id="username" placeholder="Enter Username" required="required">
                    </div>
                    <div class="input__box">
